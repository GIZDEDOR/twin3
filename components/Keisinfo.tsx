...
const technologies = [
  {
    ...
    description:
      'Наши уникальные 3D-сканеры позволяют за 1 сек оцифровать человека и интегрировать его в CG и Al-контент. Таким образом мы можем создавать любые сцены и сюжеты без искажения визуального образа персонажа, что является проблемой создания ИИ роликов с людьми на сегодня.',
  ...
  },
  {
    ...
    description:
      'Наш RnD-отдел создал собственную систему синхронизации камер и света с автоматической настройкой под разные режимы 3D и AI сканирования. Это решение обеспечивает стабильность работы сканеров при высокой нагрузке и гибкость конфигурации под задачи АI CGI продакшена.',
