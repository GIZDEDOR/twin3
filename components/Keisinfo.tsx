...
const technologies = [
  ...
  },
  {
    ...
    description:
      'Наш RnD-отдел создал собственную систему синхронизации камер и света с автоматической настройкой под разные режимы 3D и AI сканирования. Это решение обеспечивает стабильность работы сканеров при высокой нагрузке и гибкость конфигурации под задачи А CGI продакшена.',
