...
const technologies = [
  {
    id: '01',
    title: 'ДВА УНИКАЛЬНЫХ\nФОТОГРАММЕТРИЧЕСКИХ\n3D-СКАНЕРА (200 КАМЕР)',
    description:
      'Наши уникальные 3D-сканеры позволяют за 1 сек оцифровать человека и интегрировать его в графику и ИИ-контент. Таким образом мы можем создавать любые сцены и сюжеты без искажения визуального образа персонажа, что является проблемой создания нейросетевых роликов с людьми на сегодня.',
  ...
  },
  {
    ...
    description:
      'Наш отдел разработок создал собственную систему синхронизации камер и света с автоматической настройкой под разные режимы 3D и ИИ-сканирования. Это решение обеспечивает стабильность работы сканеров при высокой нагрузке и гибкость конфигурации под задачи технологичного производства контента.',
