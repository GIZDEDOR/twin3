...
const ALL_CASES = [
  {
    title: 'YOTA',
    icon: '/images/yota_466415.svg',
    category: 'РЕКЛАМА',
    video1: '/video/hero-3.webm',
    video2: '/video/center.webm',
    tags: ['РЕКЛАМА', '3D-СКАН'],
    borderColor: 'border-blue-400',
    logo: '/images/yota_466415.svg',
  },
  {
    title: 'FEDUK FEAT AMAZING RED',
    icon: '/images/red_353562.svg',
    category: 'АВАТАРЫ',
    video1: '/video/hero-1.webm',
    video2: '/video/hero-4.webm',
    tags: ['РЕКЛАМА', 'АВАТАРЫ'],
    borderColor: 'border-neutral-500',
    logo: '/images/red_353562.svg',
  },
  {
    title: 'ПЯТЁРОЧКА',
    icon: '/images/x5_540202.svg',
    category: 'ИИ-ПРОДУКТЫ',
    video1: '/video/feature-5.webm',
    video2: '/video/пять2.webm',
    tags: ['РЕКЛАМА', 'ИИ-ПРОДУКТЫ'],
    borderColor: 'border-green-400',
    logo: '/images/x5_540202.svg',
  },
];
...
export default function CaseGrid() {
  ...
  const filtered = category
    ? ALL_CASES.filter((c) => c.category === category)
    : ALL_CASES;
            ...
            {logo && (
              <div className="hidden sm:block mt-2">
                <img
                  src={logo}
                  alt="case logo"
                  className={`mx-2 my-1 opacity-20 ${
                    isPerek ? 'h-[24px] w-[30px]' : 'h-[70px] w-auto'
                  }`}
                />
              </div>
            )}
